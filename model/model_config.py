...
# Model specifications (matching actual training: EfficientNetV2M with 480x480)
MODEL_INPUT_SIZE = (480, 480)  # Expected input image size from training
MODEL_INPUT_SHAPE = (1, 480, 480, 3)  # Batch size 1, height, width, channels
