...
This guide provides step-by-step instructions for deploying AI Microscope with TensorFlow 2.18.1 and Keras 3.x in a clinical environment at Mbeya Regional Referral Hospital.
...
- [ ] **Operating System**: Ubuntu 18.04 LTS or later (or Windows 10/11)
- [ ] **Hardware**: Minimum 8GB RAM, recommended 16GB+ for 1.9GB model
...
- [ ] **Python**: Python 3.11.0 or higher required

### Software Dependencies
- [ ] **Python 3.11+**: Installed and configured
- [ ] **TensorFlow 2.18.1**: With Keras 3.x for model compatibility
...
ls -la model/best_clinical_rugged_1777619657.keras

# Check class indices file
ls -la model/class_indices.json

# Test model loading with TensorFlow 2.18.1
python -c "import tensorflow as tf; model = tf.keras.models.load_model('model/best_clinical_rugged_1777619657.keras'); print('Model OK with TensorFlow 2.18.1')"
```
...
# Test model loading
python -c "import tensorflow as tf; model = tf.keras.models.load_model('model/best_clinical_rugged_1777619657.keras'); print('Model loaded successfully')"

# Test database
python -c "from model.db import get_db; db = get_db(); print('Database OK')"
```
