...
├── USER_TRAINING_MANUAL.md    # Staff training materials
├── HARDWARE_RECOMMENDATIONS.md # Hardware specifications
└── user_facing/               # In-app help documents
    ├── getting_started.md
    ├── user_guide.md
    ├── faq.md
    ├── troubleshooting.md
    ├── clinical_best_practices.md
    └── styles.css
```
...
- 🖥️ **Medical Help System** accessible from application (F1 key)
...
- 📄 **User-facing docs** in `docs/user_facing/` for in-app help
