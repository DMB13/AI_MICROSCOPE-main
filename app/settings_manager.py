...
# Try to import app logger, fall back to standard logging
try:
...
class SettingsManager:
    ...
    def __init__(self, settings_file: Optional[str] = None):
        ...
        if settings_file is None:
            # Use the app directory for settings file
    ...
    def _load_settings(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if APP_LOGGER_AVAILABLE:
                ...
                logger.error(f"Missing key in settings: {e}")
    ...
    def save(self) -> bool:
        ...
        try:
            ...
            if APP_LOGGER_AVAILABLE:
                ...
                logger.error(f"Permission denied when saving settings: {e}")
            return False
        except json.JSONEncodeError as e:
            if APP_LOGGER_AVAILABLE:
                log_error(f"JSON encoding error when saving settings: {e}", exc_info=True)
            else:
                logger.error(f"JSON encoding error when saving settings: {e}")
            return False
        except Exception as e:
            if APP_LOGGER_AVAILABLE:
    ...
    def get_export_directory(self) -> Path:
        """Get validated export directory path from settings."""
